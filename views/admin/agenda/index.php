...
<div class="admin__contenedor-boton">
    <a class="admin__boton" href="/admin/agenda/crear">
    ...
    <?php if (!empty($eventos)) { ?>
        <table class="table">
            <thead class="table__thead">
                <tr>
                    <th class="table__th-display" scope="col">Agenda</th>
                    ...
                    <th class="table__th table__th--ponentes" scope="col">Tipo de Reunion</th>
                    <th class="table__th table__th--ponentes" scope="col">Lugar</th>
