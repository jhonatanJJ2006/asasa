// About Editor con TinyMCE - Módulo separado
(function() {
    'use strict';

    // Función principal para inicializar el editor de About
    function initAboutEditor() {
        // Verificar si TinyMCE está disponible
        if (typeof tinymce === 'undefined') {
            console.error('TinyMCE no está cargado, esperando...');
            // Intentar solo 5 veces máximo
            if (typeof initAboutEditor.attempts === 'undefined') {
                initAboutEditor.attempts = 0;
            }
            initAboutEditor.attempts++;
            
            if (initAboutEditor.attempts < 5) {
                setTimeout(initAboutEditor, 1000);
            } else {
                console.error('TinyMCE no se pudo cargar después de 5 intentos');
            }
            return;
        }

        // Verificar si el elemento del editor existe
        var editorElement = document.getElementById('descripcion');
        console.log('Buscando elemento descripcion:', editorElement);
        if (!editorElement) {
            console.log('Editor de descripción no encontrado en esta página');
            return;
        }
        
        console.log('Inicializando TinyMCE para About...');

        // Configuración de TinyMCE para About
        tinymce.init({
            ...
            // Barra de herramientas para About
            toolbar: [
            ...
            // Estilos de contenido para About
            ...
            images_upload_handler: function (blobInfo, success, failure) {
                ...
                .then(function(result) {
                    ...
                    if (result.location) {
                        ...
                        tinymce.get('descripcion').notificationManager.open({
            ...
            autosave_prefix: 'about_descripcion_',
            ...
            setup: function(editor) {
                ...
                editor.on('init', function() {
                    console.log('Editor TinyMCE inicializado para About');
            ...
            init_instance_callback: function(editor) {
                ...
                if (container) {
                    container.classList.add('about-editor-container');
                }
            }
        });
    }

    // Inicializar cuando el DOM esté listo y TinyMCE esté disponible
    ...
    // Utilidades globales para el editor de About
    window.AboutEditorUtils = {
        getContent: function() {
            var editor = tinymce.get('descripcion');
        ...
        validateContent: function() {
            ...
            if (stats.words < 10) {
                return {
                    valid: false,
                    message: 'La descripción debe tener al menos 10 palabras.'
                };
            }
            ...
            if (stats.chars < 800) {
                return {
                    valid: false,
                    message: 'La descripción debe tener al menos 800 caracteres.'
                };
            }
    ...
    console.log('About Editor con TinyMCE cargado correctamente');
})();
